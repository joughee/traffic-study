...
- Traffic_Data_Geoloc_tidy.csv - original open dataset available at http://geohub.lacity.org/datasets/traffic-data/data . Used for geocoordinates and url to web page with links to related documents.
